...
<html lang="ja">
  ...
  <body>
    ...
    <!-- body -->
    <div class="container">//Boostrapについての記述である。

	<c:if test="${errMsg != null}" >//c:ifは、カスタムタグを使った分岐である。
      ...
      <div class="card card-container">
		...
		<form class="form-signin" action="LoginServlet" method="post">//actionタグとmethodを記述
